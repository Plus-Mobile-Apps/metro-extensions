...
dependencies {
    implementation(project(":lib:dependency-graph:runtime"))
...
mavenPublishing {
    ...
    pom {
        name.set("Metro Extensions - Dependency Graph Compiler")
        description.set("KSP processor that generates a Metro @DependencyGraph + create() accessor from a marker interface.")
