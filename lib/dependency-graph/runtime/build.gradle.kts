...
android {
    namespace = "com.plusmobileapps.metro.extensions.dependencygraph.runtime"
...
mavenPublishing {
    ...
    pom {
        name.set("Metro Extensions - Dependency Graph Runtime")
        description.set("Runtime marker annotation for the Metro dependency-graph KSP extension.")
